...
Install the entire suite of **Antigravity Superpowers** and **88+ Specialized Division Skills** globally and locally with a single command:
...
```
                      ...
                      +------------------------------------------+
                                           ...
                                           v
                      +------------------------------------------+
                      |   ⚡ Antigravity Superpowers Core (13)   |
                      +------------------------------------------+
                                           |
             +---------------------+-------+-------+---------------------+
             |                     |               |                     |
             v                     v               v                     v
     +---------------+     +---------------+ +---------------+     +---------------+
     | 💻 Engineering |     |  🛡️ Security  | |   🧪 QA &     |     |   🎨 Design   |
     |   Division    |     |   Division    | |   Testing     |     |   Division    |
     |   (57 Skills) |     |  (12 Skills)  | |  (9 Skills)   |     |  (10 Skills)  |
     +---------------+     +---------------+ +---------------+     +---------------+
             |                     |               |                     |
             +---------------------+-------+-------+---------------------+
                                           |
